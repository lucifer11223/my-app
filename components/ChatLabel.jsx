...
const ChatLabel = ({ openMenu, setOpenMenu, id, name }) => {
    ...
    return (
        <div
            ...
            rounded-lg text-sm group cursor-pointer transition-colors duration-200'>

            <p className='truncate max-w-[70%] group-hover:max-w-full'>{name}</p>
            ...
            <div
                ...
                <div className={`absolute right-0 top-full mt-2 bg-gray-700 rounded-xl w-max p-2 shadow-lg ${openMenu.id === id && openMenu.open ? 'block' : 'hidden'}`}>
